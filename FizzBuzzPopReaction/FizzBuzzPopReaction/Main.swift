...
//    ]
   ...
   @State var numbersAppStorage = getDefaultVal(storeData: UserDefaults.standard.integer(forKey: "numbers"), defaultData: 8)//UserDefaults.standard.integer(forKey: "numbers")
    
   @State var roundsAppStorage = getDefaultVal(storeData: UserDefaults.standard.integer(forKey: "rounds"), defaultData: 3) //UserDefaults.standard.integer(forKey: "rounds")
 ...
 //   @State var arr:[Int] = makeList(numbersAppStorage)
    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack {
               // Text("\(numbersAppStorage)").foregroundColor(.white)
                if !isGameComlete {
                    ...
                    VStack{
                        HStack {
                            ForEach (0 ..< numbersAppStorage / 2) { i in
                                ...
                                a
                                    .onAppear {
                                        print("\(a.number) \(fizzBuzzPopChoice)")
                                        let y = a.number % 2
                                        if y == 0 {
                                            print("ok")}
                                    }
...
struct Rect: View {
   ...
   // var raiting = Storage.gameHistory
    ...
    var body: some View {
        ...
        .onTapGesture {
           ...
           // var sortedDic = Storage.gameHistory.values.sorted()
